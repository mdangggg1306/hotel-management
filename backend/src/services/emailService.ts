...
export const sendPasswordResetEmail = async (to: string, token: string) => {
  ...
  const mailOptions = {
    from: `"LuxeManage Support" <${process.env.EMAIL_USER}>`,
    to,
    subject: 'LuxeManage - Đặt lại mật khẩu',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
        <h2 style="color: #111827; text-align: center;">Yêu cầu đặt lại mật khẩu</h2>
        <p>Xin chào,</p>
        <p>Chúng tôi nhận được yêu cầu đặt lại mật khẩu cho tài khoản LuxeManage của bạn. Nếu bạn không yêu cầu điều này, xin hãy bỏ qua email này.</p>
        ...
        <p>Trân trọng,<br>Đội ngũ LuxeManage</p>
      </div>
    `,
  };
...
export const sendBookingConfirmationEmail = async (to: string, bookingDetails: any) => {
  const mailOptions = {
    from: `"LuxeManage Reservations" <${process.env.EMAIL_USER}>`,
    to,
    subject: `Xác nhận đặt phòng thành công - Mã số ${bookingDetails.booking_code}`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
        <div style="text-align: center; margin-bottom: 20px;">
          <h1 style="color: #ca8a04; font-family: Georgia, serif;">LuxeManage</h1>
        </div>
        ...
        <p>Trân trọng,<br>LuxeManage Hospitality</p>
      </div>
    `,
  };
